...
- by default, it uses an embedded FastAPI `TestClient` so the UI still works for demos and Streamlit Cloud
- if you want local auto-start behavior, set `AUTO_START_LOCAL_API=true` before running Streamlit
